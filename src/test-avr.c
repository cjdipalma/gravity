...
static void _initialize_(long m_) {
  { /* RANDOM */
  ...
  { /* CLEAR */
    ram_write(m_ + 313600, 0, 100 * sizeof (float));
  }
  ...
  { /* RANDOM */
    ...
    for (i=0; i<10000; ++i) {
      ...
      // TODO: this is an index operation with a different type of pointer. You need to use different syntax.
    }
  }
