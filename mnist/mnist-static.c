	       ...
	       int test_n)
{
	...
	for (i=0; i<test_n; ++i) {
		...
		z = (real_t *) test_activate(mem_arr, x);
...
main()
{
	...
	char *m = (char *) malloc(test_memory_size());
	...
	{
		m[i] = fgetc(file); // Tested with 0 instead of actual character. Accuracy was 0.0980
	}
	fclose(file);
	...
	// Contents of array should be dumped into a file
	/*
